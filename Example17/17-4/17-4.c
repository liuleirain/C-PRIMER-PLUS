...
int main(void) {
  ...
  cyclelimit = MIN_PER_HOUR / cust_per_hour;
  ...
  for (cycle = 0; cycle < cyclelimit; cycle++) {
    ...
    sum_line += (long)QueueItemCount(&line1) + (long)QueueItemCount(&line2);
  }
